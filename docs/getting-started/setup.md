...
Use this guide if you have **never touched Node.js or Empirica before** and want to run the annotated demo experiment locally.
...
You now have a fully working local environment and have run the annotated demo end-to-end. From here you can edit treatments, customize `.env`, and iterate on your own experiments.
