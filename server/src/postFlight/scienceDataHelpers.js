...
// Consistency check run before writing. Returns an array of error strings;
// callers push these into `exportErrors` on the JSONL row so the failure
// is visible in the exported data.
