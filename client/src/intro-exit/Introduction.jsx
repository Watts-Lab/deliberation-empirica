  ...
  return (
    <div className="ml-5 mt-1 sm:mt-5 p-5 basis-1/2">
      ...
      <div className="mt-1 mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Please pay attention when the discussion begins and&nbsp;
          <b>participate actively.</b>
        </p>
        <h3 className="mt-5 text-lg leading-6 font-medium text-gray-900">
          Payment:
        </h3>
        ...
        <p className="mt-2 text-sm text-gray-500">
          Your audio and video data may be shared with select&nbsp;
          <b>researchers who commit to confidentiality and data security.</b>
        </p>
      </div>
    </div>
  );
