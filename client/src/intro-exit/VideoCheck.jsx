    ...
    <div style={flexStyle} id="alert" className="ml-5 mt-1 sm:mt-5 p-5">
      ...
      <div className="mt-8 mb-8">
        ...
        <p className="my-8 text-md text-gray-700">
          Please wait for the meeting to connect and&nbsp; take a moment to
          familiarize yourself with the video call software.&nbsp; (You will be
          the only person in this meeting.)
        </p>
        <div style={mainStyle}>
          <center>
            {isDevelopment && (
            ...
            {isDevelopment && !videoCallEnabledInDev && (
              <h2>
                Videocall Disabled for testing.&nbsp; To enable, add URL
                parameter &quot;&amp;videoCall=true&quot;
              </h2>
            )}
            <div style={vidStyle}>
          ...
          <div style={rightStyle}>
            <p className="mt-2 text-md text-gray-700">
              <b>
                Please confirm the following to ensure you can participate in
                the discussion.
              </b>
            </p>
              ...
              <div className="ml-5 space-y-1">
                <div className="mt-1">
                  <input
                    ...
                    id="enabled"
                    onClick={() =>
                      setEnabled(document.getElementById("enabled").checked)
                    }
                  />
                  <label
                    htmlFor="enabled"
                    className="display-6 text-gray-700 my-2"
                  >
                ...
                <div className="mt-1">
                  <input
                    ...
                    id="see"
                    onClick={() =>
                      setSee(document.getElementById("see").checked)
                    }
                  />
                ...
                <div className="mt-1">
                  <input
                    ...
                    id="noName"
                    onClick={() =>
                      setNoName(document.getElementById("noName").checked)
                    }
                  />
                  <label
                    htmlFor="noName"
                    className="display-6 text-gray-700 my-2"
                  >
                    Nothing in my background reveals my full name&nbsp; (i.e. a
                    diploma on the wall, the name of an employer).
                  </label>
                </div>
                <div className="mt-1">
                  <input
                    ...
                    onClick={() =>
                      setBackground(
                        document.getElementById("background").checked
                      )
                    }
                  />
                  <label
                ...
                <div className="mt-1">
                  <input
                    ...
                    id="safeplace"
                    onClick={() =>
                      setSafePlace(document.getElementById("safeplace").checked)
                    }
                  />
                  <label
                    htmlFor="safeplace"
                ...
                <div className="mt-1">
                  <input
                    ...
                    id="speakFree"
                    onClick={() =>
                      setSpeakFree(document.getElementById("speakFree").checked)
                    }
                  />
                  <label
                    htmlFor="speakfree"
                    className="display-6 text-gray-700 my-2"
                  >
                    I am in a space where I can speak freely without bothering
                    other people.
                  </label>
                </div>
                <div className="mt-1">
                  <input
                    ...
                    onClick={() =>
                      setNoInterrupt(
                        document.getElementById("noInterrupt").checked
                      )
                    }
                  />
                  <label
