...
export default function VideoCheck({next}) {
    ...
    const [incorrectResponses, setIncorrectResponses] = React.useState(false);
    ...
    if (incorrectResponses) {
        return (
            <div id="container">
                <div className="px-10" id="alert">
                    <Alert title="Not all of the necessary items were confirmed!" children="Please confirm all of the following to continue." />
                </div>
                <VideoCheckBody />
            </div>
        )
