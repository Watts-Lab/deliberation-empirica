...
describe(
  ...
  () => {
    ...
    it("assigns players to the correct games", () => {
      ...
      cy.get(
        `[data-player-id="${playerKeys[2]}"] [data-testid="element-prompt-projects/example/multipleChoice.md"] input[value="Markdown"]`
      ).click();
      ...
      cy.get(
        `[data-player-id="${playerKeys[3]}"] [data-testid="element-prompt-projects/example/multipleChoice.md"] input[value="HTML"]`
      ).click();

      cy.get(
        `[data-player-id="${playerKeys[3]}"] [data-testid="element-prompt-projects/example/multipleChoiceWizards.md"] input[value="Merlin"]`
      ).click();

      // Player 4 is eligible for 1a, 2a, or 3
      cy.stepSurveyPoliticalPartyUS(playerKeys[4], "Republican");
      cy.get(
        `[data-player-id="${playerKeys[4]}"] [data-testid="element-prompt-projects/example/multipleChoice.md"] input[value="Markdown"]`
      ).click();

      cy.get(
        `[data-player-id="${playerKeys[4]}"] [data-testid="element-prompt-projects/example/multipleChoiceWizards.md"] input[value="Merlin"]`
      ).click();

      // Player 5 is eligible for 1b, 2b, or 3
      cy.stepSurveyPoliticalPartyUS(playerKeys[5], "Republican");
      cy.get(
        `[data-player-id="${playerKeys[5]}"] [data-testid="element-prompt-projects/example/multipleChoice.md"] input[value="HTML"]`
      ).click();

      cy.get(
        `[data-player-id="${playerKeys[5]}"] [data-testid="element-prompt-projects/example/multipleChoiceWizards.md"] input[value="Merlin"]`
      ).click();

      // Player 6 is eligible for 1a, 2a, or 3
      cy.stepSurveyPoliticalPartyUS(playerKeys[6], "Republican");
      cy.get(
        `[data-player-id="${playerKeys[6]}"] [data-testid="element-prompt-projects/example/multipleChoice.md"] input[value="Markdown"]`
      ).click();

      cy.get(
        `[data-player-id="${playerKeys[6]}"] [data-testid="element-prompt-projects/example/multipleChoiceWizards.md"] input[value="Merlin"]`
      ).click();
