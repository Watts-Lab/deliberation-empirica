...
describe("Templates", { retries: { runMode: 2, openMode: 0 } }, () => {
  ...
  it("handles templates", () => {
    ...
    cy.get(
      `[data-player-id="${playerKeys[1]}"] [data-testid="projects/example/multipleChoiceWizards.md"] input[value="Albus Dumbledore"]`
    ).click();

    cy.get(
      `[data-player-id="${playerKeys[2]}"] [data-testid="projects/example/multipleChoiceWizards.md"] input[value="Gandalf"]`
    ).click();
    ...
    cy.get(
      `[data-player-id="${playerKeys[0]}"] [data-testid="projects/example/multipleChoice.md"] input[value="HTML"]`
    ).click();

    cy.get(
      `[data-player-id="${playerKeys[2]}"] [data-testid="projects/example/multipleChoice.md"] input[value="HTML"]`
    ).click();
    ...
    cy.get(
      `[data-player-id="${playerKeys[0]}"] [data-testid="projects/example/multipleChoiceColors.md"] input[value="Plaid"]`
    ).click();

    cy.get(
      `[data-player-id="${playerKeys[2]}"] [data-testid="projects/example/multipleChoiceColors.md"] input[value="Plaid"]`
    ).click();
