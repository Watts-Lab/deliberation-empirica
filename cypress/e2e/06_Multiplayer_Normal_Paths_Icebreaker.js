...
describe(
  ...
  () => {
    ...
    it("walks properly", () => {
      ...
      // Video check1
      cy.get(`[test-player-id='${playerKeys[0]}']`).contains("Check your webcam", {
        timeout: 5000,
      });
      ...
      // Video check2
      cy.get(`[test-player-id='${playerKeys[1]}']`).contains("Check your webcam", {
        timeout: 5000,
      });
      //cy.get('[data-test="enableIframe"]').uncheck({force: true}) // default disabled in cypress
      ...
      cy.get(`[test-player-id='${playerKeys[0]}']`).find('[data-test="profile"]', {
        timeout: 20000,
      ...
      cy.get(`[test-player-id='${playerKeys[1]}']`).find('[data-test="profile"]', {
        timeout: 20000,
      }); // check that profile loaded
      ...
      cy.get(`[test-player-id='${playerKeys[0]}']`).contains("Quality Feedback Survey", {
        timeout: 5000,
      });
      ...
      cy.get(`[test-player-id='${playerKeys[1]}']`).contains("Quality Feedback Survey", {
        timeout: 5000,
      });
      cy.wait(1000); // flake mitigation
      cy.get(`[test-player-id='${playerKeys[1]}']`)
