...
describe(
  ...
  () => {
    beforeEach(() => {
      ...
      cy.empiricaCreateBatch("cypress1_2ExitSurveys");
      cy.empiricaStartBatch("cypress1_2ExitSurveys");
    });
    ...
    it("walks properly", () => {
      ...
      cy.wait(500); // flake mitigation
      cy.get('input[type="radio"][value="8"]').click({
        force: true,
        timeout: 20000,
      });
      cy.get(
        'textarea[aria-label="What is the primary reason for your score?"]'
