...
test.describe("DailyId History Logging", () => {
   ...
   */
  test("HISTORY-002: history entry includes timestamp", async ({
    mount,
    page,
  }) => {
    test.slow();
   ...
   */
  test("HISTORY-003: history entry includes progressLabel", async ({
    mount,
    page,
  }) => {
    test.slow();
   ...
   */
  test("HISTORY-004: logs new entry when Daily session ID changes", async ({
    mount,
    page,
  }) => {
    test.slow();
...
test.describe("Player Data Logging (avReports)", () => {
   ...
   */
  test("PDATA-001: avReports populated after Fix A/V diagnosis", async ({
    mount,
    page,
  }) => {
    test.slow();
   ...
   */
  test("PDATA-002: avReport entry includes required fields", async ({
    mount,
    page,
  }) => {
    test.slow();
