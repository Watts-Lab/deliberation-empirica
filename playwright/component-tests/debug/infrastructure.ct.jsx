...
test.describe("Mock Infrastructure", () => {
  test("MockEmpiricaProvider exposes context on window", async ({
    mount,
    page,
  }) => {
  ...
  test("window.mockPlayers (direct) vs context players", async ({
    mount,
    page,
  }) => {
    ...
    const comparison = await page.evaluate(() => {
      ...
      return {
        direct: {
          ...
          protoKeys: directPlayer
            ? Object.getOwnPropertyNames(Object.getPrototypeOf(directPlayer))
            : [],
        },
        context: {
          ...
          protoKeys: contextPlayer
            ? Object.getOwnPropertyNames(Object.getPrototypeOf(contextPlayer))
            : [],
        },
