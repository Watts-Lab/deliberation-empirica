...
// Derived bindings stay coherent with isMobile: when a test flips the
// window flag and refreshes, isDesktop / isTablet / deviceType update
// alongside isMobile so consumers don't see contradictory values
// (e.g. isMobile=true && isDesktop=true).
export let isMobile = computeIsMobile();
export let isDesktop = !isMobile;
export let isTablet = false;
export let deviceType = isMobile ? "mobile" : "desktop";
